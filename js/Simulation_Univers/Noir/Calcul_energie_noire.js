...
function Calc() {
	...
	console.log("121  age_sec  modele ",age_sec,modele);
	...
	i = 0;
	pas = age*1e-6;   if(modele==1){pas=1e-5;}
	yrunge = 1;
	ymoinsrunge = [1, 1];
	ymoinsrungederiv = [1, 1];
	k = [0, 0, 0, 0];
	...
	} else if (big_rip_detection(yrunge)) {  console.log("199 bigripdetection");
		let age_univ_sec;
	...
	a2=a2;  
		...
		console.log("  236   fin big rip calcul");
